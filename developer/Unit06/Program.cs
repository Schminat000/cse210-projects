...
namespace Unit06
{
    ...
    class Program
    {
        ...
        private static string CAPTION = "Poisoned Artifacts";
        private static Color WHITE = new Color(255, 255, 255);
        private static int DEFAULT_ARTIFACTS = 150;
        ...
        static void Main(string[] args)
        {
            ...
            {
                string text = objects[random.Next(0,2)];
